...
const ChipIcon = () => {
  ...
  const featureOne = () => {
    return (
        <div className="relative flex items-center justify-center mx-auto">
                    <svg className="text-blue-100" width="70" height="75" viewBox="0 0 72 75" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  const featureTwo = () => {
    return (
        <div className="relative flex items-center justify-center mx-auto">
        <svg className="text-orange-100" width="62" height="70" viewBox="0 0 62 64" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  const featureThree = () => {
    return (
        <div className="relative flex items-center justify-center mx-auto">
        <svg className="text-green-100" width="66" height="70" viewBox="0 0 66 68" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  const featureFour = () => {
    return (
        <div className="relative flex items-center justify-center mx-auto">
        <svg className="text-purple-100" width="66" height="70" viewBox="0 0 66 68" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M65.5 30C65.5 50.4345 46.4345 68 26 68C5.56546 68 0 50.4345 0 30C0 9.56546 12.5655 0 33 0C53.4345 0 65.5 9.56546 65.5 30Z" />
        </svg>
  ...
  const featureSix = () => {
    return (
        <div className="relative flex items-center justify-center mx-auto">
        <svg className="text-yellow-100" width="78" height="70" viewBox="0 0 78 78" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  export {ChartIcon,ChipIcon,BoxIcon,CloudIcon,featureOne,featureTwo,featureThree,featureFour,featureFive,featureSix}
