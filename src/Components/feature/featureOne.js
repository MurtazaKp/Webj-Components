    ...
    <section className="py-12 bg-gray-50 sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center xl:max-w-2xl">
          <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Take the next step without any hassle & get results fast</h2>
        </div>
        ...
        <div className="grid max-w-4xl grid-cols-1 mx-auto mt-8 text-center gap-y-4 sm:gap-x-8 sm:grid-cols-2 sm:mt-12 lg:mt-20 sm:text-left">
          ...
          return(
            <div key={feature.id} className="space-y-4 sm:space-y-8">
              <div className="overflow-hidden bg-white shadow-md rounded-xl">
                <div className="p-9">
                  <IconComponent/>
                  <h3 className="mt-8 text-2xl font-bold text-gray-900 sm:mt-14 font-pj">{feature.title}</h3>
                  <p className="mt-6 text-base text-gray-600 font-pj">{feature.description}</p>
                </div>
              </div>
            </div>
 )})
