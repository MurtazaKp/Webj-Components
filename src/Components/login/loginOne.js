      ...
      <div className="min-h-full lg:flex lg:justify-between">
        <div className="flex flex-col justify-center flex-1 px-4 py-12 bg-white sm:px-6 lg:px-20 xl:px-24">
          <div className="flex-1 max-w-sm mx-auto lg:max-w-md">
            <img className="w-auto h-8 mx-auto lg:mx-0" src="https://cdn.rareblocks.xyz/collection/clarity/images/logo.svg" alt="" />

            <h1 className="mt-10 text-3xl font-bold text-center text-gray-900 lg:mt-20 xl:mt-32 sm:text-4xl xl:text-5xl font-pj lg:text-left">{signInData.heading}</h1>
              ...
              <div className="flex items-center justify-between mt-5">
                <div className="relative flex items-center">
                  ...
                  <div className="ml-3 text-base">
                    <label htmlFor="terms" className="font-normal text-gray-900 font-pj">{signInData.rememberMeLabel}</label>
                  </div>
                </div>

                <a href="#" title="" className="text-base font-medium text-gray-500 rounded hover:text-gray-900 font-pj hover:underline focus:outline-none focus:ring-1 focus:ring-gray-900 focus:ring-offset-2">{signInData.forgotPasswordLink}</a>
              </div>

              <div className="relative mt-8">
                <div className="absolute -inset-2">
                  <div className="w-full h-full mx-auto opacity-30 blur-lg filter" style={svgStyle}></div>
                </div>
                ...
                >
                  {signInData.signInButtonText}
                </button>
              </div>
            </form>

            <p className="mt-10 text-base font-normal text-center text-gray-900 lg:mt-20 xl:mt-32 font-pj lg:text-left">{signInData.signUpLink}</p>
          </div>
        </div>
        ...
        <div className="relative grid flex-1 w-full px-4 py-12 overflow-hidden bg-gray-900 lg:max-w-2xl lg:px-20 xl:px-24 sm:px-6 place-items-center">
          ...
          <div className="relative max-w-sm mx-auto">
            ...
            <blockquote className="mt-14">
              <p className="text-2xl font-medium leading-relaxed text-white lg:text-3xl font-pj">{signInData.testimonial.quote}</p>
            </blockquote>

            <div className="flex items-center mt-12">
              <img className="flex-shrink-0 object-cover rounded-full w-14 h-14" src={signInData.testimonial.author.avatar} alt="" />
              <div className="ml-4">
                <p className="text-xl font-bold text-white font-pj">{signInData.testimonial.author.name}</p>
                <p className="mt-px text-lg font-normal text-gray-400 font-pj">{signInData.testimonial.author.role}</p>
              </div>
            </div>
          </div>
        </div>
