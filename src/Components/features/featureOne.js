    ...
    <section className="py-10 bg-gray-100 sm:py-16 lg:py-24">
      <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-3 text-xl leading-relaxed text-gray-600 md:mt-8">{description}</p>
        </div>
          ...
          {stats.map((stat, index) => (
            <div key={index}>
              <h3 className="font-bold text-7xl">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-blue-600">{stat.value}</span>
              </h3>
              <p className="mt-4 text-xl font-medium text-gray-900">{stat.label}</p>
