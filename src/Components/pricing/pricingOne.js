    ...
    <section className="py-12 bg-white sm:py-16 lg:py-20">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl px-8 mx-auto text-center md:px-0">
          ...
          <p className="mt-6 text-lg font-normal text-gray-600 font-pj">Choose from our affordable 3 packages</p>
        </div>
            ...
            >
              <div className="p-6 lg:px-10 lg:py-8 group-hover:bg-black duration-500 ">
                <div className="text-gray-900 group-hover:text-white duration-500">
                  <h3 className="text-lg font-bold font-pj">{pkg.name}</h3>
                  <p className="mt-3 text-5xl font-bold font-pj">{pkg.price}</p>
                  <p className="mt-5 text-base font-normal leading-7 font-pj  h-36">{pkg.description}</p>
                </div>
                <a
                  href="#"
                  title=""
                ...
                <p className="text-gray-900 mt-8 text-base font-bold font-pj group-hover:text-white duration-500">What's included:</p>
                <ul className="mt-4 space-y-3 text-base font-medium text-gray-600 font-pj">
                  ...
                  {pkg.name === 'Premium' || pkg.name === 'Enterprise' ? (
                    <>
