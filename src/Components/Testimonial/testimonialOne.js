    ...
    <section className="py-12 bg-white sm:py-16 lg:py-20 xl:py-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-base font-semibold text-blue-600">{subheading}</p>
        ...
        <div className="grid max-w-3xl grid-cols-1 gap-12 mx-auto mt-16 text-center lg:mt-20 xl:mt-20 xl:grid-cols-2 xl:max-w-none sm:text-left">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="flex flex-col sm:flex-row lg:items-center">
              <img
              ...
              <div className="mt-8 sm:mt-0 sm:ml-10">
                ...
                <blockquote className="mt-8">
                  <p className="text-lg font-medium leading-8 text-gray-900">{testimonial.quote}</p>
                </blockquote>
                <div className="flex flex-col flex-wrap items-center justify-center gap-1 mt-5 sm:flex-row sm:justify-start sm:gap-4">
                  ...
                  <p className="text-base font-normal text-gray-600">{testimonial.company}</p>
                </div>
              </div>
            </div>
          ))}
