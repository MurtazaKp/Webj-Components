...
const TestimonialTwo = ({heading,subheading,testimonials}) => {
  // Testimonials data
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          <div className="text-center">
            <p className="text-lg font-medium text-gray-600 font-pj">{subheading}</p>
            <h2 className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">{heading}</h2>
          </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center">
                        ...
                        {Array.from({ length: 5 }).map((_, starIndex) => (
                          <svg key={starIndex} className={`w-5 h-5 text-[#FDB241] ${starIndex < 4 ? 'mr-1' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                             <path
